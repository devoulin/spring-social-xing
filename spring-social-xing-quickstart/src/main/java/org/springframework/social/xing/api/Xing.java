...
public interface Xing extends ApiBinding {
	...
	/**
	 * API for retrieving and performing operations on conversations
	 */
	 ...
	 * API
	 */
	StatusMessageOperations statusMessageOperations();

	/**
	 * API
	 */
	ProfileMessageOperations profileMessageOperations();
	 ...
	 * API
	 */
	ContactRequestOperations contactRequestOperations();

	/**
	 * API
	 */
	ContactPathOperations contactPathOperations();
	 ...
	 * API
	 */
	NetworkFeedOperations networkFeedOperations();

	/**
	 * API
	 */
	ProfileVisitOperations profileVisitOperations();
	 ...
	 * API
	 */
	GeoLocationOperations geoLocationOperations();
}
